...
> 最后更新：2026-04-19（V7.15 细纲JSON解析修复：上下文截断+JSON清洗加强+max_tokens提升，修复1个BUG）
> 版本：V7.15（V7.14 + 细纲JSON解析修复：上下文截断+JSON清洗加强，修复1个BUG）
...
| **V7.15（当前）** | https://github.com/ZTNIAN/dramatica-flow-enhanced-v7 | 细纲JSON解析修复：上下文2000/1500/1500→600/400/400 + JSON补全括号 + max_tokens=4096，修复1个BUG |
